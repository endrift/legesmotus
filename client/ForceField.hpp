...
#ifndef LM_CLIENT_FORCEFIELD_HPP
#define LM_CLIENT_FORCEFIELD_HPP
...
namespace LM {
	...
	class ForceField : public BaseMapObject {
	private:
	...
	public:
		explicit ForceField(Point position);
