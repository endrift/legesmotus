...
#ifndef LM_CLIENT_REPULSIONFIELD_HPP
#define LM_CLIENT_REPULSIONFIELD_HPP
...
namespace LM {
	...
	class RepulsionField : public BaseMapObject {
	private:
	...
	public:
		explicit RepulsionField(Point position);
