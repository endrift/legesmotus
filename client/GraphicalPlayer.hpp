...
public:
	GraphicalPlayer();
	GraphicalPlayer(const char* name, uint32_t id, char team, Graphic* sprite = NULL, double x = 0, double y = 0, double xvel = 0, double yvel = 0, double rotation = 0);
	~GraphicalPlayer();
