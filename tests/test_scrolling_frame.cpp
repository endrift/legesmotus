...
#include "gui/ScrollingFrame.hpp"
#include <iostream>
...
int main(int argc, char *argv[]) {
	...
	b1.set_can_scroll(true, true);
	b1.set_bar_color(Color(0.0f, 0.0f, 0.7f, 1.0f), Widget::COLOR_PRIMARY);
	b1.set_bar_color(Color(0.3f, 0.3f, 0.7f, 1.0f), Widget::COLOR_SECONDARY);
	b1.set_bar_pressed_color(Color(0.0f, 0.0f, 0.5f, 1.0f), Widget::COLOR_PRIMARY);
	b1.set_bar_pressed_color(Color(0.5f, 0.5f, 0.9f, 1.0f), Widget::COLOR_SECONDARY);
	b1.set_bar_hover_color(Color(0.0f, 0.0f, 0.9f, 1.0f), Widget::COLOR_PRIMARY);
	b1.set_bar_hover_color(Color(0.5f, 0.5f, 0.9f, 1.0f), Widget::COLOR_SECONDARY);
	b1.set_bar_inactive_color(Color(0.0f, 0.0f, 0.3f, 1.0f), Widget::COLOR_PRIMARY);
	b1.set_bar_inactive_color(Color(0.3f, 0.3f, 0.3f, 1.0f), Widget::COLOR_SECONDARY);
	b1.set_x(200.0f);
	b1.set_y(200.0f);
