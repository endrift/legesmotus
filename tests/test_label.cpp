...
int main(int argc, char *argv[]) {
	...
	Font font(string("data/fonts/DustHomeMedium.ttf"), 30, cache, false, NULL);
	//Font cfont(string("data/fonts/JuraMedium.ttf"), 30, cache, false, NULL);
