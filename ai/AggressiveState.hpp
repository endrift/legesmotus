...
#ifndef LM_AI_AGGRESSIVESTATE_HPP
#define LM_AI_AGGRESSIVESTATE_HPP
...
namespace LM {
	class AggressiveState : public FuzzyLogicState {
	private:
		std::string m_name;
		...
		FuzzyLogic::Rule* m_rule_jump_at_gate;
	...
	public:
		AggressiveState(const FuzzyLogic* fuzzy_logic);
