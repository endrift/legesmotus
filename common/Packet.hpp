...
namespace LM {
	enum PacketEnum {
		...
		PLAYER_TO_SERVER_UPDATE_PACKET = 32,
	};
	...
	struct Packet {
		...
		union {
			...
			PlayerToServerUpdate player_to_server_update;
		};
	};
	...
	public:
		...
		virtual void player_to_server_update(const Packet& p) { }
	};
