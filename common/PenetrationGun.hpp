...
#ifndef LM_COMMON_PENETRATIONGUN_HPP
#define LM_COMMON_PENETRATIONGUN_HPP
...
#define PenetrationGun NewPenetrationGun
...
namespace LM {
	...
	class PenetrationGun : public Weapon, public b2RayCastCallback {
	private:
		// Weapon settings
		float			m_max_range;
		...
		int			m_objects_penetrated;
		
		// Data for firing/rays:
		std::vector<HitData>    m_hit_data;
